      ...
      <div className='flex gap-2 mb-6 mt-3 '>
        {
          ...
          : <div>
            <a className = 'bg-blue-100 text-blue-600 px-4 py-2 roundede' href=''>
               Resume
            </a>
          ...
          {jobsApplied.map((job,index)=> true ? (
            <tr>
              ...
              <td  className='py-2 px-4 border-b'>
                <span className={`${job.status === 'Accepted ' ? 'bg-green-100' : job.status === 'Rejected' ? 'bg-red-100' :'bg-blue-100' } px-4 py-1.2 rounded`}>
                  {job.status}
                </span>
              </td>
            </tr>
