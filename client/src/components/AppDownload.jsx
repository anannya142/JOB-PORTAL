...
const AppDownload = () => {
  return (
    <div className='container px-4 2xl:px-20 mx-auto my-20'>
        ...
        <div className='relative bg-gradient-to-r from-violet-45 to-purple-50 dark:bg-gradient-to-l from-purple-700 to-purple-800 p-12 sm:p-24 lg:p-32 rounded-lg'>
            <div>
